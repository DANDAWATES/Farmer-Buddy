<?php
	...
	$q1="select * from tbl_farmer_bill";
	$result=$con->query($q1);
	...
	$sql = "INSERT INTO tbl_farmer_bill VALUES ('$bno','$fcode','$date','$oname','$fname','$ton','$rate','$total_amt')";
...
.container
{
  width:500px;
    ...
    <body>
        ...
        <br>
        <!-- create table tbl_farmer_bill(bno int primary key,fcode int references tbl_farmer(fcode)
                                             on delete cascade on update set null,Date date,oname text,
                                             fname text,ton int,rate int,total_amt int);

         -->
         <div class="container">
           <form  method="post" class="form-horizontal" role="form"  action="admin_f_bill.php">

 
            <h2>Bill for Farmer</h2>
